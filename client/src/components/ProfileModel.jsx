                ...
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            ...
                            rounded-lg' onChange={(e) => setEditForm({ ...editForm, profile_picture: e.target.files[0] })} />
                            ...
                            <label htmlFor='cover_photo' className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/cover relative'>
                                    <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} alt=''
                                        className='w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200
                                    object-cover mt-2'/>
                        ...
                        <div>
                            ...
                            ' placeholder='Please enter your full name ' onChange={(e) => setEditForm({
                        ...
                        <div>
                            ...
                            <input type='text' className='w-full p-3 border border-gray-200 rounded-lg
                            ' placeholder='Please enter a username ' onChange={(e) => setEditForm({
                        ...
                        <div>
                            ...
                            ' placeholder='Please enter a short bio ' onChange={(e) => setEditForm({
